...
- Include 5-9 main branches with 2-5 sub-branches each for richer visualization
- Focus on hierarchical relationships and connections
- Keep labels compact: each branch/sub label must be a short phrase (max ~8 words), not paragraphs
- Do not use file metadata, filenames, URLs, or "source unavailable" filler text in nodes
