...
const nl: ToolStrings = {
  ...
  quiz: {
    ...
    modeOptions: [
      { value: 'practice', label: 'Oefenen', description: 'Ontspannen modus met hints en uitleg na elke vraag' },
      { value: 'normal', label: 'Normaal', description: 'Standaard quiz met score aan het einde' },
      { value: 'exam', label: 'Examen', description: 'Strikt getimed examen — geen terug, geen hints' },
      ...
      { value: 'adaptive', label: 'Adaptief', description: 'Moeilijkheid past zich aan op basis van je prestaties' },
    ...
    packOptions: [
      { value: 'practice', label: 'Oefenen', description: 'Lichtere vragen gericht op begrip' },
      { value: 'exam', label: 'Examen', description: 'Strikte vragen op examenniveau' },
      { value: 'adaptive', label: 'Adaptief', description: 'Mix van moeilijkheden die zich aanpast' },
      ...
      { value: 'application', label: 'Toepassing', description: 'Scenariovragen voor praktijkgebruik' },
    ],
    difficultyOptions: [
