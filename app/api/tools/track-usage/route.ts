...
// Tracks: quizzes, flashcards, notes, blocks, materials and any AI-generated content
// Valid tool types: 'quiz', 'flashcard', 'note', 'block', 'material', 'general'
// All tools share the same daily limit
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { tool_type } = await request.json().catch(() => ({ tool_type: 'general' }));
