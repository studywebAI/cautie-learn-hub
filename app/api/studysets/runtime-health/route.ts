...
const REQUIRED_TABLES = [
  ...
  'studyset_tool_profiles',
  'studyset_intervention_queue',
  'studyset_daily_pulses',
...
const REQUIRED_COLUMNS: Record<string, string[]> = {
  ...
  studyset_tool_profiles: ['id', 'studyset_id', 'tool_key', 'avg_score', 'recommended_action'],
  studyset_intervention_queue: ['id', 'studyset_id', 'kind', 'status', 'priority'],
  studyset_daily_pulses: ['id', 'studyset_id', 'pulse_date', 'avg_score', 'pending_tasks', 'summary'],
