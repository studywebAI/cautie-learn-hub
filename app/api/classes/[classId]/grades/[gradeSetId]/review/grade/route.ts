...
// POST /api/classes/[classId]/grades/[gradeSetId]/review/grade
// Single-answer flashcard verdict: goed/fout + optional note. Mirrors the
// scoring logic in the existing open-answers bulk route, one card at a time.
