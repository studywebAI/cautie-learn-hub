          ...
          <div className="bg-background rounded-lg border border-border p-6 w-full max-w-2xl shadow-xs">
            ...
            <div className="flex gap-4 mb-5 h-56">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <textarea
                  ...
                  className="flex-1 w-full p-3 border border-border rounded-lg text-sm text-foreground resize-none outline-none leading-relaxed focus:border-[var(--accent-brand)] focus:ring-2 focus:ring-[var(--accent-brand)]/10 transition-colors bg-muted/30 font-sans"
                />
            ...
            <div className="flex gap-2 justify-end border-t border-border pt-4">
              <button
                ...
                className="px-4 py-2 bg-background border border-border rounded-md text-xs font-medium text-foreground hover:bg-accent/10 hover:border-accent/50 transition-all"
              >
                Clear
              </button>
              <button
