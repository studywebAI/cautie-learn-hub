...
const sidebarMenuButtonVariants = cva(
        "peer/menu-button relative flex w-full items-center gap-2 overflow-hidden rounded-xl p-1.5 pl-2.5 text-left text-[13px] font-normal text-[hsl(var(--sidebar-foreground)/0.94)] outline-none transition-[width,height,padding,color,background-color] duration-150 hover:bg-[hsl(var(--sidebar-accent)/0.6)] hover:text-sidebar-foreground active:bg-[hsl(var(--sidebar-accent)/0.7)] active:text-sidebar-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-[hsl(var(--sidebar-accent)/1)] data-[active=true]:font-normal data-[active=true]:text-sidebar-foreground dark:data-[active=true]:text-white data-[active=true]:shadow-[inset_0_0_0_1px_rgba(0,0,0,0.06)] data-[state=open]:hover:bg-[hsl(var(--sidebar-accent)/0.7)] data-[state=open]:hover:text-sidebar-foreground group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!p-2.5 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
