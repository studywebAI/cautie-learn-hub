    ...
    <div className="grid gap-4 rounded-2xl bg-zinc-200/70 p-3 lg:grid-cols-[240px_minmax(0,1fr)]">
        ...
        <CardContent className="space-y-3">
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              ...
              <Button className="bg-zinc-100 hover:bg-zinc-200/70 text-black border-0" variant="outline" size="icon" onClick={() => void copyText(studentJoinCode, 'Student join code')}>
          ...
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              ...
              <Button className="bg-zinc-100 hover:bg-zinc-200/70 text-black border-0" variant="outline" size="icon" onClick={() => void copyText(teacherJoinCode, 'Teacher join code')}>
                <Copy className="h-4 w-4" />
              </Button>
            </div>
          </div>
          <Button className="bg-zinc-100 hover:bg-zinc-200/70 text-black border-0" variant="outline" onClick={() => void handleRegenerateCodes()} disabled={regeneratingCodes}>
      ...
      <Card className="border-0 bg-zinc-100 shadow-none">
        ...
        <CardContent className="space-y-4">
          ...
          <Button className="bg-zinc-100 hover:bg-zinc-200/70 text-black border-0" onClick={() => void createScheduleSlot()} disabled={!canCreateScheduleSlot}>
            ...
            {loadingSchedule ? (
              ...
              scheduleSlots.map((slot) => (
                <div key={slot.id} className="rounded-md bg-zinc-100 p-3 flex items-center justify-between gap-3">
                  ...
                  <Button className="bg-zinc-100 hover:bg-zinc-200/70 text-black border-0" variant="outline" size="sm" onClick={() => void deleteScheduleSlot(slot.id)}>
                    Remove
                  </Button>
                </div>
              ))
          ...
          {loadingJoinRequests ? (
            ...
            pendingJoinRequests.map((request) => (
              <div key={request.id} className="rounded-lg bg-zinc-100 p-3 flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    className="bg-zinc-100 hover:bg-zinc-200/70 text-black border-0"
                    size="sm"
      ...
      <Card className="border-0 bg-zinc-100 shadow-none">
        ...
        <CardContent className="space-y-3">
          ...
          <Button className="bg-zinc-100 hover:bg-zinc-200/70 text-black border-0" onClick={() => void handleImport()} disabled={importing || !importSourceId}>
