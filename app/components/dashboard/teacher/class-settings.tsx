  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[240px_minmax(0,1fr)]">
      <aside className="lg:sticky lg:top-4 self-start">
        <Card className="border-0 bg-gray-100/70 shadow-none">
              ...
              <Button
                ...
                className={`h-auto w-full justify-start rounded-md px-3 py-2 text-left ${
                  activeSettingsSection === section.id
                    ? 'bg-gray-300 text-black shadow-[inset_0_0_0_1px_rgba(0,0,0,0.08)] hover:bg-gray-300'
                    : 'text-foreground/80 hover:bg-gray-200/70'
                }`}
              >
      ...
      <Card className="border-0 bg-gray-100/60 shadow-none">
        <CardHeader>
      ...
      <Card className="border-0 bg-gray-100/60 shadow-none">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-1">
            ...
            >
              <SelectTrigger className="h-9 rounded-md border-0 bg-gray-200/70 text-sm">
          ...
          <div className="flex items-center justify-between rounded-md bg-gray-200/60 p-3">
            <div>
          ...
          <div className="space-y-2">
            {loadingSchedule ? (
              ...
              scheduleSlots.map((slot) => (
                <div key={slot.id} className="rounded-md bg-gray-200/60 p-3 flex items-center justify-between gap-3">
                  <div>
        ...
        <CardContent className="space-y-3">
          {loadingJoinRequests ? (
            ...
            pendingJoinRequests.map((request) => (
              <div key={request.id} className="rounded-lg bg-gray-200/60 p-3 flex items-center justify-between gap-3">
        ...
        <CardContent className="space-y-3">
          {loadingInviteActivity ? (
            ...
            inviteActivity.map((item) => (
              <div key={item.id} className="rounded-lg bg-gray-200/60 p-3">
      ...
      <Card className="border-0 bg-gray-100/60 shadow-none">
        ...
        <CardContent className="space-y-4">
          {loadingSubjects ? (
            ...
            subjects.map((subject) => (
              <div key={subject.id} className="rounded-lg bg-gray-200/60 p-4 space-y-3">
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2 rounded-md bg-gray-200/60 p-2 max-h-36 overflow-auto">
                      {teachers.map((teacher) => {
      ...
      <Card className="border-0 bg-gray-100/60 shadow-none">
        ...
        <CardContent>
          {!isArchived ? (
            <div className="flex items-center justify-between p-4 rounded-lg bg-gray-200/60">
              <div>
            ...
            <div className="flex items-center justify-center p-4 rounded-lg bg-gray-200/60">
