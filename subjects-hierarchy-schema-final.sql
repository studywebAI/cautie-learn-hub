-- Final working SQL migration for subjects hierarchy
-- Fixed parameter name conflict

-- Drop existing function if it exists with different parameter name
DROP FUNCTION IF EXISTS get_next_assignment_index(uuid);
...
-- Helper function for letter conversion
...
-- Fixed function name to avoid conflict
